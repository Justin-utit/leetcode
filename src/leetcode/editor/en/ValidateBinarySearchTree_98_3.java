...
public class ValidateBinarySearchTree_98_3 {

    public ValidateBinarySearchTree_98_3(Integer[] nums) {
        this.nums = nums;
    }
    public ValidateBinarySearchTree_98_3() {
    }
    ...
    public static void main(String[] args) {
        Solution solution = new ValidateBinarySearchTree_98_3().new Solution();

        Integer[] nums =
                {5,1,4,null,null,3,6};
        ValidateBinarySearchTree_98_3 obj = new ValidateBinarySearchTree_98_3(nums);
        obj.buildtree();
