...
public BinaryTreePreorderTraversal_144(Integer[] nums) {
    this.nums = nums;
}
    public BinaryTreePreorderTraversal_144() {
    }
    ...
    public static void main(String[] args) {
        ...
        Integer[] nums =
                {1,null,2,3};
        BinaryTreePreorderTraversal_144 obj = new BinaryTreePreorderTraversal_144(nums);
        obj.buildtree();
